...
- :ref:`type <web3-module-abstract-subscription-subscribe>` - ``String`` The subscriptions type ``ccm_subscribe`` or ``shh_subscribe``.
...
``String`` - ``ccm_subscribe`` or ``shh_subscribe``
