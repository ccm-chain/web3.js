...
describe('GetTransactionFromBlockMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('ccm_getTransactionByBlockNumberAndIndex');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('ccm_getTransactionByBlockHashAndIndex');
    });
