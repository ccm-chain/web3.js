...
describe('GetBlockUncleCountMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getBlockUncleCountMethod.rpcMethod).toEqual('ccm_getUncleCountByBlockNumber');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getBlockUncleCountMethod.rpcMethod).toEqual('ccm_getUncleCountByBlockHash');
    });
