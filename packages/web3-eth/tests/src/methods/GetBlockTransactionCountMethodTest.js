...
describe('GetBlockTransactionCountMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('ccm_getBlockTransactionCountByNumber');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('ccm_getBlockTransactionCountByHash');
    });
